...
import 'package:greenhornscoe/login/reset.dart';
import 'package:greenhornscoe/login/signup.dart';
  ...
  _buildLoginForm() {
    return Padding(
        ...
        child: ListView(children: [
          ...
          Container(
            child: Image.asset('assets/images/miniicon.png'),
          )
        ]));
  }
}